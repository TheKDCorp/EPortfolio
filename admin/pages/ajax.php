...
if(!empty($_POST['method'])){
	...
	if($_POST['method']=="activity_addnew"){
	    $activityname = $_POST['ac_name'];
	    $quality1 = $_POST['ac_quality1'];
	    $quality2 = $_POST['ac_quality2'];
	    $quality3 = $_POST['ac_quality3'];
	    $quality4 = $_POST['ac_quality4'];
	    $quality5 = $_POST['ac_quality5'];
	    $quality6 = $_POST['ac_quality6'];
	    $quality7 = $_POST['ac_quality7'];
	    $quality8 = $_POST['ac_quality8'];
	    $quality9 = $_POST['ac_quality9'];
	    $quality10 = $_POST['ac_quality10'];
	    $sql = "INSERT INTO activity(activityid,activityname,field1name,field1type,field2name,field2type,field3name,field3type,field4name,field4type,field5name,field5type,field6name,field6type,field7name,field7type,field8name,field8type,field9name,field9type,field10name,field10type)values(DEFAULT,'$activityname','$quality1','status','$quality2','status','$quality3','status','$quality4','status','$quality5','status','$quality6','status','$quality7','status','$quality8','status','$quality9','status','$quality10','status')";
	    $conn->query($sql);
	}

	if($_POST['method']=="activity_getdetails"){
		$output = array();

	    $activityid = $_POST['acid'];
	    ...
	    if($result->num_rows > 0){
	    	...
	    	$output['quality1'] = $row['field1name'];
	    	$output['quality2'] = $row['field2name'];
	    	$output['quality3'] = $row['field3name'];
	    	$output['quality4'] = $row['field4name'];
	    	$output['quality5'] = $row['field5name'];
	    	$output['quality6'] = $row['field6name'];
	    	$output['quality7'] = $row['field7name'];
	    	$output['quality8'] = $row['field8name'];
	    	$output['quality9'] = $row['field9name'];
	    	$output['quality10'] = $row['field10name'];
	    }
	    header('Content-Type: application/json');
	    echo json_encode($output);
	}

	if($_POST['method']=="activity_update"){
		$output = array();

	    $activityid = $_POST['acid'];
	    $activityname = $_POST['name'];
	    $activityquality1 = $_POST['quality1'];
	    $activityquality2 = $_POST['quality2'];
	    $activityquality3 = $_POST['quality3'];
	    $activityquality4 = $_POST['quality4'];
	    $activityquality5 = $_POST['quality5'];
	    $activityquality6 = $_POST['quality6'];
	    $activityquality7 = $_POST['quality7'];
	    $activityquality8 = $_POST['quality8'];
	    $activityquality9 = $_POST['quality9'];
	    $activityquality10 = $_POST['quality10'];

	    $sql = "UPDATE activity SET activityname='$activityname',field1name='$activityquality1',field2name='$activityquality2',field3name='$activityquality3',field4name='$activityquality4',field5name='$activityquality5',field6name='$activityquality6',field7name='$activityquality7',field8name='$activityquality8',field9name='$activityquality9',field10name='$activityquality10' where activityid='$activityid'";
	    $conn->query($sql);
	    echo json_encode($output);
	}

	if($_POST['method']=="activity_delete"){
		$output = array();
	...
	if($_POST['method']=="teacher_addnew"){
	    $teachername = $_POST['teacher_name'];
	    $username = $_POST['teacher_username'];
	    $password = $_POST['teacher_password'];

	    $sql = "INSERT INTO teacher_entry(uid,name,username,password,active,dp)values(DEFAULT,'$teachername','$username','$password','yes','')";
	    echo $sql;
	    $conn->query($sql);

	    $sql = "SELECT * FROM teacher_entry order by uid desc limit 1";
	    echo $sql;
	    $result = $conn->query($sql);
	    if($result->num_rows > 0){
	    	$row = $result->fetch_assoc();
		    $target_file = "../../images/teacher/".md5($row['uid']).".jpg";
		    $uid = $row['uid'];
			if (move_uploaded_file($_FILES["dp"]["tmp_name"], $target_file)) {
			    $dp = md5($row['uid']);
			} else {
	    ...
	    $sql = "UPDATE teacher_entry SET dp='$dp' where uid=$uid";
	    echo $sql;
	    $conn->query($sql);
	}

	if($_POST['method']=="teacher_delete"){
		$output = array();

	    $teacherid = $_POST['tcid'];

	    $sql = "DELETE FROM teacher_entry where uid='$teacherid'";
	    $conn->query($sql);
	    echo json_encode($output);
	}

	if($_POST['method']=="teacher_getdetails"){
		$output = array();

	    $teacherid = $_POST['tcid'];

	    $sql = "SELECT * FROM teacher_entry where uid='$teacherid'";
	    $result = $conn->query($sql);
	    if($result->num_rows > 0){
	    	$row = $result->fetch_assoc();
	...
	if($_POST['method']=="teacher_update"){
		$teacherid = $_POST['teacher_id'];
		$teachername = $_POST['teacher_name'];
	    $username = $_POST['teacher_username'];
	    $password = $_POST['teacher_password'];

	    $sql = "UPDATE teacher_entry(uid,name,username,password,active,dp)values(DEFAULT,'$teachername','$username','$password','yes','')";
	    $conn->query($sql);

	    $target_file = "../../images/teacher/".md5($teacherid).".jpg";
		if (move_uploaded_file($_FILES["dp"]["tmp_name"], $target_file)) {
		    $dp = md5($teacherid);
		} else {
		    $dp = "";
		...
		if($dp==""){
			$sql = "UPDATE teacher_entry SET name='$teachername',username='$username',password='$password' where uid='$teacherid'";
		}else{
			$sql = "UPDATE teacher_entry SET name='$teachername',username='$username',password='$password',dp='$dp' where uid='$teacherid'";
		}
		echo $sql;
    	$conn->query($sql);  
	}

	if($_POST['method']=="adminprofile_update"){
	    $profile_username = $_POST['profile_username'];
	    $profile_oldpassword = $_POST['profile_oldpassword'];
	    $profile_newpassword = $_POST['profile_newpassword'];

	    $sql = "SELECT * FROM admin_members where password='$profile_oldpassword'";
	    $result = $conn->query($sql);
	    if($result->num_rows > 0){
			$sql = "UPDATE admin_members SET username='$profile_username',password='$profile_newpassword'";
	    	$conn->query($sql);  
	    }else{
	    	echo "no";
	    }
