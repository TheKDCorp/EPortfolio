                        ...
                        <li class="dropdown dropdown-user nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <?php 
                                        echo '<img alt="avatar" src="../images/profile.jpg">';
                                ?>
                                <span class="user-name text-bold-700 ml-1">Admin</span></span></a>
                                    <div class="dropdown-divider"></div><a class="dropdown-item" href="./profile.php"><i class="ft-user"></i> Change Password</a>
