    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="../assets/images/backgrounds/02.jpg">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="<?php if($filename=='class.php'){echo 'active';} ?> nav-item"><a href="class.php"><i class="ft-pie-chart"></i><span class="menu-title" data-i18n="">Class Details</span></a>
                </li>
                <li class="<?php if($filename=='section.php'){echo 'active';} ?> nav-item"><a href="section.php"><i class="ft-droplet"></i><span class="menu-title" data-i18n="">Section Details</span></a>
                </li>
                <li class="<?php if($filename=='portfolio.php'){echo 'active';} ?> nav-item"><a href="portfolio.php"><i class="ft-box"></i><span class="menu-title" data-i18n="">Portfolio</span></a>
                </li>
